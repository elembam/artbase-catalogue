# The Provable Collection

*On the great wealth transfer, and why a collection is only worth what its record can show.*

---

## A trillion dollars, looking for a home
...
None of this began in 2026. For more than a decade, appraisers and auctioneers have described the same flood: downsizing households, dining sets and silver and mahogany no one wants, a market for traditional antiques that has quietly lost something like half its value in fifteen years. The trade even has a name for the casualties — "brown furniture." The heirs said no thank you to the china a decade ago. The wave has simply reached fine art.

One line from that older coverage turns out to be the whole diagnosis, written before anyone dressed it in strategy language: antiques, a dealer observed, don't translate to the digital realm. They are not part of the point-and-click universe. You cannot look them up.
...
Here is the quiet mechanism that turns a collection into a problem.
